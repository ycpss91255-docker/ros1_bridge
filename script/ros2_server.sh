...
#
# Owns roscore + parameter_bridge: Ctrl+C tears both down. ROS 1 is sourced
# only because parameter_bridge needs both distros — the publish itself is
# pure ROS 2.
...
main() {
    ...
    ros2 topic pub -r 1 "${TOPIC}" std_msgs/msg/String "{data: '${message}'}"
}
